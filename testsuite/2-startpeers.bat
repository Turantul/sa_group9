...
IF EXIST "%~dp0..\peer\target" GOTO STARTPEERS
...
copy "%~dp0swazam.h2.db" "%~dp0..\peer\target\classes\data\"
...
REM start console
start mvn exec:java -Dexec.mainClass="sa12.group9.peermanagement.Launcher"
